...
const AllIssues = () => {
    ...
    return (
        <section className="bg-base-200 py-20 md:py-32 min-h-screen">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-16" data-aos="fade-down">
                    ...
                    <h1 className="font-['Satoshi'] text-4xl md:text-5xl font-bold text-base-content mb-4 leading-tight">
                        All Citizen Reports
                    </h1>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-10">
                    ...
                    <div className="hidden lg:block lg:col-span-1 h-fit">
                        <div className="p-6 bg-base-100 rounded-xl shadow-lg sticky top-24 border border-base-300">
                            <h3 className="font-bold text-lg mb-4 border-b border-base-300 pb-2 text-base-content">Filter Options</h3>
                            <FilterSidebar
                    ...
                    <div className="lg:col-span-3">
                        {isLoading ? (
                            ...
                            <div className="text-center py-20 bg-error/10 rounded-xl text-error border border-error/20">
                                <p className="font-['Satoshi'] font-semibold mb-2">Error loading issues</p>
                                <p className="text-sm text-error/80">{error?.message || 'Please try again later'}</p>
                            </div>
                        ) : issues.length > 0 ? (
                            <>
                            ...
                            <div className="p-16 bg-base-100 rounded-xl text-center shadow-lg border-2 border-dashed border-base-300" data-aos="zoom-in">
                                <h3 className="font-['Satoshi'] text-xl font-bold text-base-content">No Reports Found</h3>
                    ...
                    <div className="lg:hidden fixed bottom-6 left-1/2 transform -translate-x-1/2 z-40 w-full max-w-xs px-4">
                        <button
                            ...
                            className="w-full py-4 bg-primary text-primary-content rounded-full font-bold shadow-2xl flex items-center justify-center gap-2"
                        >
            ...
            {isMobileFilterOpen && (
                <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex justify-end transition-opacity">
                    <div className="w-4/5 max-w-sm bg-base-100 h-full overflow-y-auto p-6 shadow-2xl animate-slideInRight">
                        <div className="flex justify-between items-center mb-6 border-b border-base-300 pb-4">
                            <h3 className="font-bold text-xl text-base-content">Filters</h3>
                            <button
                        ...
                        <button
                            onClick={() => setIsMobileFilterOpen(false)}
                            className="w-full mt-8 bg-primary text-primary-content py-3 rounded-xl font-bold"
                        >
                            View Results
                        </button>
                    </div>
