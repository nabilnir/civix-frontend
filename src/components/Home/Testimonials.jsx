...
const Testimonials = ({ testimonialsData = mockTestimonialsData }) => {
  ...
  return (
    <section className="py-16 md:py-32 bg-[#f4f6f8] px-6 overflow-hidden" data-aos="fade-up" data-aos-duration="1000">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative h-[400px] flex items-center justify-center mb-8">
          <AnimatePresence initial={false} custom={direction}>
            {getVisibleTestimonials().map((review) => (
              ...
              >
                <div className="bg-white rounded-3xl p-8 shadow-xl mx-4 border-t-4 border-[#238ae9]">
                  
                  {/* Quote Icon - Changed color to primary blue */}
                  <FiMessageSquare className="w-12 h-12 text-[#238ae9] mb-4 rotate-180" />

                  {/* Review Text */}
                  <p className="text-gray-700 text-base md:text-lg mb-6 leading-relaxed font-['Satoshi']">
                    {review.review}
                  </p>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    />
                    <div>
                      <h4 className="font-bold text-[#242424] text-lg font-['Satoshi']">
                        {review.userName}
                      </h4>
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-sm text-gray-600 ml-2 font-['Satoshi']">
                          {review.ratings}
                        </span>
                      </div>
                    </div>
        ...
        <div className="flex items-center justify-center gap-4" data-aos="fade-up" data-aos-duration="800" data-aos-delay="600">
          ...
          <button
            onClick={handlePrev}
            className="w-12 h-12 rounded-full bg-white border border-gray-300 flex items-center justify-center hover:bg-gray-100 transition-colors shadow-md"
            aria-label="Previous review"
          >
            <FiChevronLeft className="w-6 h-6 text-[#242424]" />
          </button>
          ...
          <button
            onClick={handleNext}
            className="w-12 h-12 rounded-full bg-gradient-to-br from-[#238ae9] to-[#1e7acc] flex items-center justify-center hover:shadow-lg transition-colors shadow-md"
