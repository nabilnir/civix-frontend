...
const IssueCard = ({ issue, index, onUpvote }) => {
    ...
    return (
        <div
            className={`bg-base-100 rounded-xl shadow-lg overflow-hidden border transition-all duration-300 hover:shadow-xl group ${isHighPriority
        ...
        >
            ...
            <div className="p-5">
                <div className="flex justify-between items-start mb-3 gap-2">
                    ...
                    {onUpvote && (
                        <button
                            ...
                            className="flex items-center gap-1 text-base-content/50 hover:text-primary transition-colors group flex-shrink-0"
                ...
                <h3 className="font-['Satoshi'] text-lg font-bold text-base-content mb-2 line-clamp-2 min-h-[3rem]">
                    <Link
                        to={`/issue/${issue._id}`}
                ...
                <div className="space-y-1.5 text-sm text-base-content/70 mb-4 font-['Satoshi']">
                ...
                <Link
                    to={`/issue/${issue._id}`}
                    className="inline-flex items-center text-primary font-bold text-sm hover:underline group/link font-['Satoshi']"
                >
                    View Details
