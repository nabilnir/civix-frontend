  ...
  return (
    <div className={`drawer ${isDrawerOpen ? 'drawer-open' : ''} lg:drawer-open`}>
      ...
      <div className="drawer-content flex flex-col w-full">
        ...
        <div className="navbar w-full bg-base-100 border-b border-base-300 lg:hidden sticky top-0 z-30">
          ...
          <div className="flex-1 px-2">
            <span className="font-['Satoshi'] font-bold text-lg text-base-content">Dashboard</span>
          </div>
        </div>

        {/* Page content */}
        <div className="flex-1 overflow-auto bg-base-200 min-h-screen">
